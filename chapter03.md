...
ここで〈具象〉ということでどういうことを言わんとしているのかが、やや曖昧である。animal（動物）に対して、dog（犬）は明らかに、**個々の、他と区切られた、形をもつ、数えられるものである**という感じがする。その意味では、dogやcatやlionなどの様々な名詞を抽象化したのがanimalである、といえる。しかしanimalも〈普通名詞〉である。There are only three animals in the zoo.（その動物園には3頭しか動物がいない。）などと述べることができる。さらに言えば、dogじたい、golden retriever（ゴールデンレトリーバ）やchihuahua（チワワ）などの様々な名詞を抽象化したものである。
