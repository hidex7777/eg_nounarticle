# 第2節　〈名詞〉について(1)：〈固有〉と〈一般〉、〈可算〉と〈不可算〉
...
「犬」はさらに、「秋田犬」や「柴犬」などに分類できるし、〈形容詞〉で修飾すれば「黒い犬」「白い犬」「大きい犬」「小さい犬」などと無限に分類できる。しかし、「犬」というカテゴリーを無限に分析していっても、タロウにたどり着くことはない。現実世界の「犬」カテゴリーを無限に分析していけば、「柴犬でオスで9kgの重量があって第n染色体にaという遺伝子配列があって……である犬」と、その個体（ここではタロウ）を一意的に指し示すことができる「属性」を並べていくことができるが、どこまで分析しても、タロウという成分は抽出されない。犬のなかにタロウは存在していないのだろうか。
